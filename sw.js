// VaqueroApp Service Worker v4 - iOS Safari compatible
const CACHE_NAME = 'vaqueroapp-v4';
        ...
        .catch(() =>
          caches.match('/app.html')
            ...
            .then(c => c || new Response(
              '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>body{background:#080c07;color:#c6f135;font-family:sans-serif;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;margin:0;text-align:center;padding:20px}h2{font-size:24px;margin-bottom:12px}p{color:#fff;font-size:15px;opacity:.8}</style></head><body><h2>VaqueroApp</h2><p>Sin conexion a internet. Conectate y recarga la pagina.</p></body></html>',
